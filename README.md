...
2. Install the required dependencies:
   ...
   npm install
   ```
3. Replace `'8243930858:AAFp9-15UphKEZMj1pNXKrpcqCo2fM0ZBFw'` with your actual Telegram bot token in the `index.js` file:
   ```javascript
   var token = '8243930858:AAFp9-15UphKEZMj1pNXKrpcqCo2fM0ZBFw';
   ```
4. Run the bot:
   ```bash
   node index.js
